...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{capturas/portada.png}
  \caption{Sección ``¿Cómo usar el laboratorio?'' con los cuatro pasos.}
\end{figure}
...
\begin{itemize}
  ...
  \item \textbf{Archivematica}:
        \url{http://labhumanidades.udistrital.edu.co:62080}
  \item \textbf{AtoM}:
...
El laboratorio agradece sus aportes para mejorar continuamente sus servicios y
herramientas.
