...
\begin{itemize}
  ...
  \item \textbf{IMPORTANTE: } La ejecución de un script de bash en el manual se indiica bash nombre\_comando, la palabra bash hace referencia a: ./nombre\_comando , tomar siempre esto en cuenta a la hora de ejecutar un script. 
\end{itemize}
